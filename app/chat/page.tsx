...
//   useEffect(() => {
//     console.log("Chat page mounted", sessionId)
...
//           {context.loadingMessages && context.messages.length === 0 ? (
...
//   useEffect(() => {
//     console.log("ChatPage along with sidebar mounted");
//     return () => {
//       console.log("ChatPage along with sidebar unmounted");
//     };
//   },[])
