...
import { Bot, Send, Menu, RefreshCw, X, User, AlertCircle, FileText } from "lucide-react";
...
export default function ChatDetailPage() {
  ...
  const {getChatMessagesById, messages, isTyping, input, handleSend, initialLoading, handleNewChat, setSidebarOpen, error, setInput, loadingMessages} = useChat();
  ...
  const handleSendExistingMessage = async (e?: React.FormEvent) => {
    e?.preventDefault();
  ...
  return (
    <div className="flex flex-col flex-1 min-w-0 h-dvh">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-2 max-w-[85%]">
                        ...
                        {/* Source References - Show if context was used */}
      ...
      <div className="p-4 bg-white border-t sticky bottom-0">
        <div className="max-w-2xl mx-auto space-y-4">
          {/* Suggestion Chips - Only show if conversation has no messages yet */}
          ...
          <form onSubmit={handleSendExistingMessage} className="relative flex items-center gap-2">
            <input
              type="text"
              value={input}
