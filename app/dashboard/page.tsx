...
import { Upload, FileText, Activity, Users, MessageSquare, TrendingUp, Loader2 } from "lucide-react"
...
const DUMMY_STATS: DashboardStats = {
  ...
  totalChunks: 15400,
  recentUploads: [
    { id: "1", pdf_name: "Patient_Care_v2.pdf", file_size: 2.4 * 1024 * 1024, document_chunks: 156 },
    { id: "2", pdf_name: "Clinical_Trials.pdf", file_size: 5.8 * 1024 * 1024, document_chunks: 312 },
    { id: "3", pdf_name: "Medication_Guide.pdf", file_size: 1.2 * 1024 * 1024, document_chunks: 78 },
  ],
  patientQueries: 1284,
  activeUsers: 573,
}
  ...
  const fetchDashboardStats = async () => {
    try {
      ...
      if (result.success && result.data) {
        ...
        setStats({
          totalDocuments: fetchedData.totalDocuments || DUMMY_STATS.totalDocuments,
          recentDocumentsCount: fetchedData.recentDocumentsCount || DUMMY_STATS.recentDocumentsCount,
          ...
          patientQueries: fetchedData.patientQueries || DUMMY_STATS.patientQueries,
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">
            Manage your medical knowledge base and monitor patient interactions.
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            {loading ? (
              ...
              <>
                <div className="text-2xl font-bold">{formatNumber(stats.patientQueries || 0)}</div>
                <p className="text-xs text-muted-foreground">
                  {usingRealData ? "Tracked queries" : "Demo data - Coming soon"}
                </p>
              </>
            )}
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            {loading ? (
              ...
              <>
                <div className="text-2xl font-bold">{formatNumber(stats.totalChunks)}</div>
          ...
          <CardContent>
            {loading ? (
              ...
              <>
                ...
                <p className="text-xs text-muted-foreground">
                  {usingRealData ? "Live interactions" : "Demo data - Coming soon"}
                </p>
              </>
            )}
          </CardContent>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-full lg:col-span-4">
          <CardHeader>
            ...
            <CardDescription>
              Knowledge retrieval and response latency across the hospital network.
            </CardDescription>
          </CardHeader>
                  ...
                  {stats.recentUploads.map((file, i) => (
                    ...
                    >
                      ...
                      <div className="flex-1 space-y-1">
                        <p className="text-sm font-medium leading-none">{file.pdf_name}</p>
                        <p className="text-xs text-muted-foreground">
        ...
        <Card className="border-amber-500/20 bg-amber-500/5">
          <CardContent className="pt-6">
            <p className="text-sm text-muted-foreground text-center">
              📊 Currently showing demo data. Upload your first PDF to see real statistics.
            </p>
          </CardContent>
        </Card>
      )}
